...
$select_sql = "SELECT prayCounter, cur_date FROM pray_counter1 WHERE phone_number = '$phone_number' ORDER BY serial DESC LIMIT 1";
...
if ($result->num_rows > 0) {
    ...
    if ($existing_cur_date == $cur_date) {
        ...
        $update_sql = "UPDATE pray_counter1 SET prayCounter = $pray_count WHERE phone_number = '$phone_number' AND cur_date = '$cur_date'";
        ...
        $insert_sql = "INSERT INTO pray_counter1 (phone_number, prayCounter, cur_date, updated_timestamp) 
